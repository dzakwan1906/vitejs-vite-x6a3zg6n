...
// --- BAGIAN 1: DEFINISI TIPE (Agar TypeScript Diam & Senang) ---
// Kita kasih tahu: "Hei TS, semua Ikon BOLEH menerima properti 'filled' ya!"
interface IconProps {
  filled?: boolean;
  className?: string;
}
...
// --- BAGIAN 2: IKON MANUAL (Diperbaiki agar Universal) ---
const IconBase = ({ path, className }: { path: React.ReactNode; className?: string }) => (
  <svg 
...
// Semua ikon sekarang MENGIZINKAN props (props: IconProps), meskipun tidak dipake.
const Icons = {
  Search: (props: IconProps) => <IconBase {...props} path={<><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></>} />,
  
  Heart: ({ filled, className }: IconProps) => (
  ...
  Zap: (props: IconProps) => <IconBase {...props} path={<polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon>} />,
  
  Bookmark: ({ filled, className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill={filled ? "currentColor" : "none"} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className || "w-full h-full"}>
      <path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"></path>
    </svg>
  ),
  
  Type: (props: IconProps) => <IconBase {...props} path={<><polyline points="4 7 4 4 20 4 20 7"/><line x1="9" y1="20" x2="15" y2="20"/><line x1="12" y1="4" x2="12" y2="20"/></>} />,
  
  FileText: (props: IconProps) => <IconBase {...props} path={<><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></>} />,
  
  Image: (props: IconProps) => <IconBase {...props} path={<><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></>} />,
  
  X: (props: IconProps) => <IconBase {...props} path={<><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></>} />,
  
  ExternalLink: (props: IconProps) => <IconBase {...props} path={<><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></>} />,
  
  Share2: (props: IconProps) => <IconBase {...props} path={<><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"/></>} />,
};
...
const TrendHubPro = () => {
  ...
  useEffect(() => {
    // Kita pakai tipe 'any' untuk interval agar aman di semua browser/node
    let interval: any;
      ...
      <nav className="fixed top-0 w-full z-40 bg-white/90 backdrop-blur border-b border-gray-100 px-4 md:px-8 py-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex p-1 bg-gray-100 rounded-full self-center md:self-auto overflow-x-auto max-w-full">
          {[
            ...
            // Trik khusus agar TypeScript tahu ini komponen React
